...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : Doni\nContact Me : 👉 line.me/ti/p/~doniagustian1",    
    "commentOn":True,
    "commentBlack":{},
    ...
    try:
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in Creator:
                return
            cl.sendText(op.param1,"Dadah " + cl.getContact(op.param2).displayName +  "\nYg suka Baper Jangan join group 🤗")
        ...
        if op.type == 25:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Gak Ada Kerjaan Bot Di tag",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag!","Kakak gangguin nih tag dede😠","jangan tag Lagi Off", cName + " Kenapa Tag Saya?","Dia Lagi Tidur\nJangan Di Tag " + cName, "Jangan Suka Tag Gua " + cName, "kasian jones ngetag bot " + cName + "berisik jangan tag", "Ada Perlu Apa nge tag" + cName + "berisik aku dah bilang jangan tag","Woii ada jones ngetag bot😄" + cName + " Jangan Ngetag, ngajak Riibut!"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
        ...
        if op.type == 25:
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"╔═══════════════\n║itu creator saya\n║jika minat sewa\n║Bot self\n║Bot protect\n║add id line\n║http://line.me/ti/p/~doniagustian1\n╚═══════════════")
		...
		cl.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            elif msg.text in ["Key 2","help 2","Help 1"]:
                cl.sendText(msg.to,groupMessage)

            elif msg.text in ["Key","help","Help"]:
                cl.sendText(msg.to,helpMessage)

            elif msg.text in ["Key 3","help 3","Help 2"]:
                cl.sendText(msg.to,selfMessage)

            elif msg.text in ["Key 5","help 5","Help 3"]:
                cl.sendText(msg.to,setMessage)

            elif msg.text in ["Key 6","help 6","Help 4"]:
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "u3f2f024bfb418f735157dc53ea8ce64e"
                cl.inviteIntoGroup(msg.to,[midd])
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = ["http://dl.profile.line-cdn.net/0h2hi-mLWibUdUVEF6jMcSEGgRYyojemsPLDB1IiZVMHIqM3kUaDt1J3NQM3N_MXgVamZyKCMANHIt"]

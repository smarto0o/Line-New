...
cl = LINETCR.LINE() #Konoha
cl.login(token="Enq0pf0q6JlIancZO8Ob.UdwLjeqPikMAOWh25mdzsW.WoZPOLSJY+Zz4VFcgB9wBZXbjzo+Y7IskwwAd9k8CKY=")
cl.loginResult()

ki = LINETCR.LINE() #kakashi
ki.login(token="En7Kohzi0Oy3vnD9D2cd.eYrnvLmoYVtzng7g00cIxq.rRCclBFqNnIpX9weuVwiE0PxUL8C3QTiNj1rlD8sR0Q=")
ki.loginResult()

kk = LINETCR.LINE() #Naruto
kk.login(token="EnvgpZoV9rVm0dY19ds9.MWZ54yoga4o06/+AkAGCQq.Gy/Qwia/X0Nhgifo7rhnW1d3meGm9buH4gvzvXO3z2A=")
kk.loginResult()

kc = LINETCR.LINE() #Sasuke
kc.login(token="EnZWSLl8Kz8Ky2HmVKD7.LYqePLf2nacZLRp5YVB8bW.cF/xQTTHZch+v5SaMZ4itMcrsrMGaAJDJB+dIo/PWc8=")
kc.loginResult()

ks = LINETCR.LINE() #Sakura
ks.login(token="En6sS6dNVffXFCadiNV0.Oy6eUeSoOMBbaZvyx1FRaa.Pknz1QJVvFfJDFmukD99F80WjiTfZjWSr/qlr6M+NF0=")
ks.loginResult()
...
helpMessage ="""sҽѵҽղ հҽαѵҽղ
O͍w͍n͍e͍r͍ :͍ ✍͍D͍o͍n͍i͍
-==================-
◄]·♦·Menu For Public·♦·[►
[•]Adminlist
[•]Ownerlist
...
admin=["u3f2f024bfb418f735157dc53ea8ce64e","ueaf4c705d8811203cf16e198fd5c8660","u2f53c72bcc1a9c49d1a542edec2d2f54","u78534eb905fb7f4590edb70e14bfd8ad","u0350203c328b2c4f7e4ad1631e55c141","u8a9936d0b8d42676bb8e525b87b30d3e","u8e8ac3676788f6ed7980a8457524c47d"] 
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            elif "Kakashi kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_second kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "Naruto kick " in msg.text:
              if msg.from_ in admin:
            ...
            elif "Kakashi invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("sinvite ","")
                ki.findAndAddContactsByMid(midd)
                ki.inviteIntoGroup(msg.to,[midd])
            elif "Naruto invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("tinvite ","")
                kk.findAndAddContactsByMid(midd)
                kk.inviteIntoGroup(msg.to,[midd])
            elif "Sasuke invite " in msg.text:
              if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                ...
                if txt[1] == "on":
                    ...
                    if jmlh <= 300:
                        ...
                        cl.sendText(msg.to, "Kelebihan batas :v")
    #-----------------=Selesai=------------------
            elif msg.text in ["Mybot"]: #Ngirim Semua Kontak Bot
              if msg.from_ in admin:
                msg.contentType = 13
            ...
            elif msg.text in ["Kakashi buka qr","Kakashi open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Naruto buka qr","Naruto open qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Sasuke open qr","Sasuke buka qr"]:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
            elif msg.text in ["Kakashi close qr","Kakashi tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Naruto tutup qr","Naruto close qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Sasuke tutup qr","Sasuke close qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
		...
		for ticket_id in n_links:
            ...
            elif "Konoha" == msg.text:
              if msg.from_ in admin:
                cl.sendText(msg.to,Smid)
            elif "Kakashi" == msg.text:
              if msg.from_ in admin:
                ki.sendText(msg.to,mid)
            elif "Naruto" == msg.text:
              if msg.from_ in admin:
                kk.sendText(msg.to,Amid)
            elif "Sasuke" == msg.text:
              if msg.from_ in admin:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Join","One piece","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Minggat","Kabur all","Kaboor all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Konoha⭐⭐👈\n\n™Seven Heaven Smule™")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^7H Bot^\nStatus Boss udah Kami Like\nOwner Kami :\nDoni agustian")
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"=====Ready=====\n[★]Bot Protect For Group\n[★]\n[★]Selfbot in Your Account[★]\n- 1 Selfbot 1 Bot Assist\n- 1 Selfbot 2 Bot Assist\n- 1 Selfbot 3 Bot Assist\n- 1 Selfbot 4 Bot Assist\n- 1 Selfbot 5 Bot Assist\n\nMau Coba Atau Test Terlebih Dahulu Bisa\nMinat??? PM Id Line @Doniagustian1\nLagi Promo Lho Kak\n===[★]7H Bot Protect[★]===")
                    print "Like"
                except:
                    pass
